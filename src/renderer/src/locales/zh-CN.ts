...
export default {
  ...
  prompt: {
    ...
    contentZh: '中文提示词内容',
    contentZhLabel: '中文提示词内容',
    contentZhPlaceholder: '输入中文提示词内容...',
    contentEn: '英文提示词内容',
    contentEnLabel: '英文提示词内容',
  ...
  tooltip: {
    ...
    downloadInstall: '下载并安装',
    permanentlyDeleteAllData: '永久删除所有数据',
  ...
  toast: {
    ...
    updateError: '更新出错',
    updateInstallFailed: '更新安装失败，请重试',
    updateCacheCleared: '更新缓存已清理',
  ...
  dialog: {
    ...
    whatsNew: '更新内容：',
    downloadAndInstall: '下载并安装',
    updateRetryTitle: '更新安装失败',
    updateRetryMessage: '上次更新安装未成功，是否重新下载并安装 {version}？',
    retryDownload: '重新下载',
    ignoreUpdate: '忽略此版本',
    installNow: '立即安装',
    restartToInstall: '重启应用以完成安装，未保存的更改将会丢失。',
    // 集合
  ...
  systemHealth: {
    ...
    localNode: '本地节点',
    localNodeStatus: '运行正常',
    operatingCapacity: '运行正常',
    searchIndex: '搜索索引',
    searchIndexStatus: '最近同步',
    lastSynced: '最近同步',
    database: '数据库',
    databaseStatus: '{count} 个项目',
    items: '{count} 个项目',
    collections: '集合',
    collectionsStatus: '{count} 个工作区',
