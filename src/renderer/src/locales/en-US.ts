...
export default {
  ...
  toast: {
    ...
    updateInstallFailed: 'Update installation failed, please retry',
    updateCacheCleared: 'Update cache cleared',
    clearCacheFailed: 'Failed to clear update cache',
    // Data Management
  ...
  dialog: {
    ...
    whatsNew: "What's new:",
    downloadAndInstall: 'Download & Install',
    updateRetryTitle: 'Update Installation Failed',
    updateRetryMessage: 'Last update installation was unsuccessful. Re-download and install {version}?',
    retryDownload: 'Re-download',
    ignoreUpdate: 'Ignore',
    installNow: 'Install Now',
    restartToInstall: 'Restart to complete installation. Unsaved changes will be lost.',
    // Collections
  ...
  systemHealth: {
    ...
    localNode: 'Local Node',
    localNodeStatus: 'Operating normally',
    operatingCapacity: 'Operating at 100% capacity',
    searchIndex: 'Search Index',
    searchIndexStatus: 'Last synced just now',
    lastSynced: 'Last synced just now',
    database: 'Database',
    databaseStatus: '{count} items',
    items: '{count} items',
    collections: 'Collections',
    collectionsStatus: '{count} workspaces',
