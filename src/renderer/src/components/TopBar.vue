  ...
  <header class="w-full h-16 sticky top-0 z-40 bg-white/70 backdrop-blur-xl flex items-center justify-between px-8 border-b border-slate-200/15 shadow-sm">
    ...
    <div class="flex items-center gap-6">
      ...
      <div class="flex items-center gap-2">
        <div class="w-8 h-8 rounded-full bg-surface-container-high overflow-hidden border border-slate-100 cursor-pointer hover:ring-2 hover:ring-primary/20 transition-all">
