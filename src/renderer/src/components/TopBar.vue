<template>
  <header
    class="w-full h-16 sticky top-0 z-40 bg-white/70 backdrop-blur-xl flex items-center justify-between px-8 border-b border-slate-200/15 shadow-sm">
    <div class="flex items-center gap-4 flex-1">
      <div class="relative w-full max-w-md group">
        ...
        <input v-model="store.searchQuery" @input="handleSearch"
          ...
          :placeholder="t('common.searchPrompts')" type="text" />
    ...
    <div class="flex items-center gap-6">
      <div class="flex items-center gap-4">
        ...
        <Tooltip :text="t('tooltip.help')" placement="bottom">
          <button @click="showHelpModal = true" class="text-slate-400 hover:text-slate-900 transition-colors">
      ...
      <Tooltip :text="t('tooltip.feedback')" placement="bottom">
        <button @click="showFeedbackModal = true" class="text-slate-400 hover:text-slate-900 transition-colors">
      ...
      <div class="max-h-80 overflow-y-auto">
        ...
        <div v-else>
          <div v-for="notification in notifications" :key="notification.id"
            ...
            :class="{ 'bg-blue-50/50': !notification.read }" @click="handleNotificationClick(notification)">
    ...
    <!-- Help Modal -->
    <Teleport to="body">
      <div v-if="showHelpModal" class="fixed inset-0 bg-black/50 flex items-center justify-center z-[9999]"
        ...
        <div class="bg-white rounded-2xl w-full max-w-4xl h-[80vh] overflow-hidden shadow-2xl flex">
          ...
          <div class="w-64 bg-surface-container-low border-r border-slate-100 flex flex-col">
            ...
            <nav class="flex-1 overflow-y-auto p-2">
              <button v-for="sectionId in helpSectionIds" :key="sectionId" @click="activeSection = sectionId"
                ...
                <span class="material-symbols-outlined text-sm align-middle mr-2">{{ helpSectionIcons[sectionId]
                }}</span>
              ...
              <div v-if="activeSection === 'library'" class="prose prose-slate max-w-none">
                ...
                <div class="space-y-4">
                  ...
                  <div class="p-4 bg-surface-container-low rounded-xl">
                    ...
                    <p class="text-sm text-slate-500 mt-2">点击左侧边栏的分类标签，可以快速筛选特定类型的提示词（如 Image Generation、Video
                      Prompt、Coding 等）。</p>
                  </div>
                  <div class="p-4 bg-surface-container-low rounded-xl">
                    <h4 class="font-semibold text-on-surface flex items-center gap-2">
              ...
              <div v-if="activeSection === 'collections'" class="prose prose-slate max-w-none">
                ...
                <div class="space-y-4">
                  <div class="p-4 bg-surface-container-low rounded-xl">
                    ...
                    <p class="text-sm text-slate-500 mt-2">在 Collections 页面点击 "New Collection" 按钮，输入名称、描述、选择图标和颜色即可创建。
                    </p>
                  </div>
                  <div class="p-4 bg-surface-container-low rounded-xl">
    ...
    <!-- Feedback Modal -->
    <Teleport to="body">
      <div v-if="showFeedbackModal" class="fixed inset-0 bg-black/50 flex items-center justify-center z-[9999]"
          ...
          <div class="p-6 space-y-4">
            <div>
              ...
              <div class="flex gap-2">
                <button v-for="type in feedbackTypes" :key="type.value" @click="feedbackType = type.value"
            ...
            <div>
              ...
              <textarea v-model="feedbackContent" rows="4"
                ...
                :placeholder="t('feedback.contentPlaceholder')"></textarea>
            </div>

            <div>
              <label class="block text-sm font-medium text-on-surface mb-2">{{ t('feedback.contactLabel') }}</label>
              <input v-model="feedbackContact" type="text"
            ...
            <div class="pt-2 space-y-3">
              <button @click="sendFeedbackEmail"
              ...
              <a href="https://github.com/OYYH-Apple/Promptly-AI/issues/new" target="_blank" rel="noopener noreferrer"
